defmodule SpoutTest do
  ...
  test "validate output" do
    ...
    # Passing tests
    passing_test(passing_1, 1, "passing test")
    failing_test(passing_2, 2, "failing test")
    passing_test(passing_3, 3, "description")
    ...
    passing_test(diagnostic, 6, "diagnostic test")
